...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CircleImageView profileimg = headerView.findViewById(R.id.nav_h_img);
        TextView name = headerView.findViewById(R.id.nav_h_name);
        TextView email= headerView.findViewById(R.id.nav_h_email);
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (userModel.getProfileImg() != null){
                            Glide.with(getApplicationContext()).load(userModel.getProfileImg())
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                ...
                R.id.nav_newProduct,R.id.nav_myOrders,R.id.nav_myCarts)
